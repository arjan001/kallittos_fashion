        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-background/60 text-sm mt-4 leading-relaxed max-w-xs">
              Curated thrift and brand-new denim pieces. From straight legs to mom jeans, dungarees to jackets -- your one-stop denim destination.
            </p>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              <Link href="/shop?category=straight-leg" className="text-background/60 text-sm hover:text-background transition-colors">
                Straight Leg Jeans
              </Link>
              ...
              <Link href="/shop?category=ripped-rugged" className="text-background/60 text-sm hover:text-background transition-colors">
                Ripped & Rugged
              </Link>
              <Link href="/shop?category=wide-leg-flare" className="text-background/60 text-sm hover:text-background transition-colors">
                Wide Leg & Flare
              </Link>
